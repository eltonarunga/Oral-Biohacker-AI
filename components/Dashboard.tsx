        ...
        <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                 ...
                 <div>
                    ...
                    <div className="flex flex-col items-stretch justify-start rounded-xl overflow-hidden bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-gray-700 cursor-pointer hover:shadow-lg transition-shadow" onClick={() => onNavigate('plan')}>
            ...
            <div>
                <h2 className="text-gray-900 dark:text-gray-50 text-xl font-bold leading-tight tracking-[-0.015em] mb-3">Daily Habits</h2>
                <div className="flex flex-col gap-3 mb-4">
                 ...
                 <div className="flex flex-col gap-6">
                    {groupedHabits.map(group => (
                        <div key={group.title}>
                            <h3 className="text-gray-500 dark:text-gray-400 text-sm font-medium uppercase tracking-wider mb-2 px-1">{group.title}</h3>
