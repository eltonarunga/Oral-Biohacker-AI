      ...
      {plan && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <section>
                <h3 className="text-lg font-semibold mb-2 text-blue-600 dark:text-blue-400 flex items-center"><RoutineIcon />Habits & Routines</h3>
                 <ul className="space-y-2 text-sm">
                    {plan.routines.map((r, i) => <li key={i} className="bg-white dark:bg-slate-700/50 p-3 rounded-lg border border-gray-200 dark:border-gray-600"><strong className="text-gray-900 dark:text-gray-100">{r.name}</strong> ({r.frequency}): <span className="text-gray-600 dark:text-gray-400">{r.instructions}</span></li>)}
                </ul>
            </section>
          </div>
          <section>
